                                ...
                                <c:if test="${empty allAdsCombo}">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex col-6" style="width: 48%">
                                            <a class="w-100" href="${pageContext.request.contextPath}/advertising/combo"><button class="btn btn-light border w-100">Quick start with combo</button></a>
                                        </div>
                                    </div>
                                </c:if>
                                <c:if test="${not empty allAdsCombo}">
                                    <c:forEach var="adsCombo" items="${allAdsCombo}">
                                        <div data-ads="${adsCombo.adsDetailId}" class="d-flex flex-row align-items-center mb-4 pb-1">
                                            <!-- Display content for each adsCombo -->
                                            <h6>${adsCombo.title}</h6>
                                            <p>View post: ${adsCombo.maxView}</p>
                                            <p>${adsCombo.budget} VND</p>
                                            <p>${adsCombo.durationDay} day</p>
                                            <p>Rate: <span id="rate">${(adsCombo.budget/adsCombo.maxView/adsCombo.durationDay)}</span> VND/view per day</p>
