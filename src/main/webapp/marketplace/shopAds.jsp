    ...
    <div class="card mx-2">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                <a style="color: black;" class="text-decoration-none">Sponsored</a>
            </p>
        ...
        fetch(urlMessage)
            ...
            .then(dataAdsMessage => {
                ...
                if (dataAdsMessage.ad && dataAdsMessage.ad.adsId) { // Check if valid ad dataAdsMessage is returned
                    ...
                    document.getElementById('adsOrganizer').innerText = dataAdsMessage.user.userFullName; // Sponsor name
