                                                        ...
                                                        <div class="col-md-6 d-flex justify-content-end">
                                                            <table class="table">
                                                                <tbody class="totals">
                                                                    ...
                                                                    <c:set var="orderdiscountlist" value="${Shop_DB.getAllOrderDiscountByOrderID(ordernotconfirm.order_ID)}" />
                                                                    ...
                                                                    <tr class="border-top border-bottom">
                                                                        ...
                                                                        <td>
                                                                            <div class="text-right">
                                                                                <span class="font-weight-bold text-success">${totalPrice - (totalPrice * selectedDiscount.discountPercent / 100) - ((totalPrice -(totalPrice * selectedDiscount.discountPercent / 100))  * (generalDiscount.discountPercent / 100))} VND</span>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
