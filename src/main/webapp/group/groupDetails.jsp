                        ...
                        <div class="bg-white shadow rounded overflow-hidden">
                            ...
                            <div class="container-fluid pt-0">
                                <div class="row form-settings bg-white shadow rounded py-4 px-4 d-flex justify-content-between ">
                                    ...
                                    <a href="${pageContext.request.contextPath}/inGroup?groupId=${group.groupId}" id="memberGroupBtn" class="btn btn-primary" >Group Members</a>
                                    ...
                                    <c:if test="${group.createrId == USER.userId}">
                                        <a href="${pageContext.request.contextPath}/groupPendingRequest?groupId=${group.groupId}" id="pendingRequestBtn" class="btn btn-primary" >Pending Requests</a>
