                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <c:if test="${user.userRole == 0}">
                                                                    <li>
                                                                        <form id="unbanUserForm_${user.userId}" action="${pageContext.request.contextPath}/admin/ManageUsers" method="post">
                                                                            ...
                                                                            <input type="hidden" name="action" value="unBanInAllUser">
                                                                            <button type="button" class="dropdown-item" onclick="confirmUnban('unbanUserForm_${user.userId}')">Unban</button>
                                                                        </form>
                                                                    </li>
                                                                </c:if>
                                                                    <c:if test="${user.userRole == 1}">
                                                                    <li>
                                                                        <form id="setManagerForm_${user.userId}" action="${pageContext.request.contextPath}/admin/ManageUsers" method="post">
                                                                            <input type="hidden" name="userId" value="${user.userId}">
                                                                            <input type="hidden" name="action" value="setMInAllUser">
                                                                            <button type="button" class="dropdown-item" onclick="confirmSetM('setManagerForm_${user.userId}')">Set manager</button>
                                                                        </form>
                                                                    </li>
                                                                </c:if>
                                                                <c:if test="${user.userRole == 2}">
                                                                    <li>
                                                                        <form id="revokeManagerForm_${user.userId}" action="${pageContext.request.contextPath}/admin/ManageUsers" method="post">
                                                                            <input type="hidden" name="userId" value="${user.userId}">
                                                                            <input type="hidden" name="action" value="revokeMInAllUser">
                                                                ...
                                                                <li>
                                                                    <form id="banUserForm_${user.userId}" action="${pageContext.request.contextPath}/admin/ManageUsers" method="post">
                                                                        <input type="hidden" name="userId" value="${user.userId}">
                                                                        <input type="hidden" name="action" value="banUserInAllUser">
