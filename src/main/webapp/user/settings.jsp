                ...
                <div class="row form-settings bg-white shadow rounded py-4 px-4 d-flex justify-content-between ">
                    ...
                    <form action="setting" method="post" enctype="multipart/form-data">
                        <div class="form-group pb-3">
                            ...
                            <input type="text" class="form-control" name="fullName" value="${userInfo.userFullName}">
                        </div>
                        <div class="form-group pb-3">
                            <label>Email:</label>
                            <input type="email" class="form-control" name="email" value="${userInfo.userEmail}" disabled>
                        </div>
                        <div class="form-group pb-3">
                            <label>About:</label>
                            <textarea class="form-control" name="story">${userInfo.userStory}</textarea>
                        </div>
                        <div class="form-group pb-3">
                            <label for="avatar">Avatar:</label>
                            <input type="file" class="form-control" id="avatar" name="avatar">
                        </div>
                        <input type="hidden" name="oldAvatar" value="${userInfo.userAvatar}">
                        <div class="form-group pb-3">
                            <label>Gender:</label>
                            <select class="form-control" name="gender">
                                ...
                                <option value="Other" ${userInfo.userSex == 'Other' ? 'selected' : ''}>Other</option>
                            </select>
                        </div>
